# seelect — іс-шараңызға арналған мамандар
...
| `extracted/tokens.json` | Design tokens: 14 colors, 1 fonts, 9 headings, 0 CTAs |
...
- **Colors**: #0E0D0D (surface-dark), #FFFFFF (bg-light), #E2E2E2 (surface-light), #E5E7EB (bg-light), #F86130 (accent), #FAFAFA (bg-light), #626161 (neutral), #C13E16 (accent), #E5322B (accent), #FB8A35 (accent)
- **Fonts**: IBM Plex Sans (400,500,600,700)
