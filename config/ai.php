    ...
    */
    ...
    'providers' => [
        ...
        'openai-compatible' => [
            ...
            'url' => env('OPENAI_COMPATIBLE_URL', 'https://llm.alem.ai/v1'),
            'key' => env('OPENAI_COMPATIBLE_API_KEY'),
            'models' => [
                'text' => [
                    'default' => env('CONTRACTOR_AI_MODEL', 'qwen3-8'),
                    'cheapest' => env('CONTRACTOR_AI_MODEL', 'qwen3-8'),
                    'smartest' => env('CONTRACTOR_AI_MODEL', 'qwen3-8'),
                ],
            ],
        ],
